...
Current product requirements are now maintained in [Product Requirements](../PRD.md), with current design details in [High-Level Design](../HLD.md) and [Low-Level Design](../LLD.md). This MVP document is a historical baseline and should not be used as the complete current product definition.

...
Current product authority: [Product Requirements](../PRODUCT_REQUIREMENTS.md). Current system-design authority: [High-Level Design](../HIGH_LEVEL_DESIGN.md). This workflow file should stay source-verified and should not describe planned behavior as current.

...
- `v0.1.0` is frozen.
- `v0.2.0` is historical release-candidate documentation.
- `v0.3.0` is the active release candidate pending production verification.
- Active v0.3 release source of truth: [V0.3_RELEASE_CHARTER.md](../releases/V0.3_RELEASE_CHARTER.md).
...
- Active v0.3 release charter: [V0.3_RELEASE_CHARTER.md](../releases/V0.3_RELEASE_CHARTER.md)
- v0.3 release notes: [V0_3_0_RELEASE_NOTES.md](../releases/V0_3_0_RELEASE_NOTES.md)
- Historical v0.2 scope: [V0_2_SCOPE.md](../scope/V0_2_SCOPE.md)
...
Release-related documentation must stay aligned. Future feature PRs must not silently modify the v0.3 release boundary; scope changes need an explicit reviewed product decision.

...
| SIM-010 | Queue reorder                        | `QueuePage.tsx`, queue service/repository                                            | Needs preparation | Manual reorder, two-phase update, final-state exclusion, doctor-scoped validation.            | Prepare multi-doctor verification example.                      |
